...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2018 at 05:22 PM
...
(1, 'Ronan Adriel Zenatti', '355.936.478-79', '41.324.990-6', '1988-02-25', 'Rua dos Lavradores', '302', 'Centro', 'Boracéia', 'AM', '17.270-000', NULL, 'ronan', '3500.00', 'ronan', 'YmpKbmJUSTNOekk9', 'U', 1);
...
--
ALTER TABLE `contratos`
  MODIFY `idcontrato` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `servicos`
  MODIFY `idservico` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `veiculos_clientes`
--
ALTER TABLE `veiculos_clientes`
  MODIFY `idvc` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
